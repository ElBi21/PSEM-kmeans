...
\begin{table}
    ...
    \resizebox{\linewidth}{!}{
        \begin{tabular}{|c|c|c|c|}
            ...
            \textbf{Runtime}$^{1a}$ & $0.05633 \pm 0.02272$ & $0.12794 \pm 0.03329$ & $8.46844 \pm 1.29596$ \\
            \hline \rowcolor{lightgray!40}
            \textbf{Speedup}$^{1a}$ & $6.28 \times$ & $8.32 \times$ & $13.14 \times$ \\
            \hline\hline
            \textbf{Runtime}$^{1b}$ & $0.038851 \pm 0.00758$ & $0.03343 \pm 0.00402$ & $1.25401 \pm 0.00367$ \\
            \hline
            \textbf{Speedup}$^{1b}$ & $9.11 \times$ & $31.86 \times$ & $88.74 \times$ \\
            \hline\hline
            \textbf{Runtime}$^{2b}$ & $0.00545 \pm 0.00006$ & $0.00993 \pm 0.00004$ & $0.50741 \pm 0.00337$ \\
            \hline
            \textbf{Speedup}$^{2b}$ & $35.92 \times$ & $61.9 \times$ & $126.83 \times$ \\
            \hline\hline
            \textbf{Runtime}$^{3b}$ & $0.00522 \pm 0.00008$ & $0.00873 \pm 0.00008$ & $0.16875 \pm 0.00018$ \\
            \hline
            \textbf{Speedup}$^{3b}$ & $67.82 \times$ & $121.99 \times$ & $659.44 \times$ \\
            \hline
        \end{tabular}
    }
    
    \nwl
    \textasteriskcentered$^a$: \textbf{without} a correct handling of memory coalescing + \textbf{without} using the shared memory\\
    \textasteriskcentered$^b$: \textbf{with} a correct handling of memory coalescing + \textbf{using} the shared memory
    \nwl
    \textasteriskcentered$^1$: executed on an \textbf{RTX Quadro 6000}\\
    \textasteriskcentered$^2$: executed on a \textbf{GeForce RTX 4060}\\
    \textasteriskcentered$^3$: executed on a \textbf{GeForce RTX 5080}
\end{table}
